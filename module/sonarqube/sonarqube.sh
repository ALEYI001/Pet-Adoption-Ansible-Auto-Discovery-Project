...
# SonarQube Installation, PostgreSQL, and Nginx Reverse Proxy Setup Script (User Data)
# Target OS: Ubuntu Linux (LTS)
# --------------------------------------------------------------------------------------
...
DB_NAME="sonarqube"
DB_USER="sonar"
DB_PASSWORD="Aleyi@123!" # IMPORTANT: Change this password for production use
